...
#define MAX_DIMENSION ((INIT_MATRIX_WIDTH>INIT_MATRIX_HEIGHT) ? INIT_MATRIX_WIDTH : INIT_MATRIX_HEIGHT)
...
void SetupRandomPalette()
{
  currentPalette = CRGBPalette16(
                     CHSV( random8(), 255, 32),
                     CHSV( random8(), 255, max_bright),
                     CHSV( random8(), 128, max_bright),
                     CHSV( random8(), 255, max_bright));
}
...
{
  CRGB purple = CHSV( HUE_PURPLE, 255, max_bright);
  CRGB green  = CHSV( HUE_GREEN, 255, max_bright);
